...
interface AuthContextType {
  ...
  login: (accessToken: string, refreshToken: string, username: string) => Promise<boolean>;
  logout: () => Promise<void>;
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // Login function
  const login = async (accessToken: string, refreshToken: string, username: string): Promise<boolean> => {
    try {
      // Store tokens
