import { Question } from "./gameService";
...
export const MOCK_QUESTIONS: Record<string, Question[]> = {
	"Cyber Security": [
		{
			id: 1,
			question:
				"A friendly stranger in a work uniform is trying to get into your workplace building. They say that someone at the head office sent them, but they forgot their pass. What should you do?",
		...
		},
		{
			...
			category: "Cyber Security",
			options: ["Web address", "Operating system", "Server software", "Port number"],
	...
	AI: [
		...
		},
		{
			...
			category: "AI",
			options: ["Data storage", "Pattern recognition and prediction", "Network security", "Hardware acceleration"],
	...
	Data: [
		...
		},
		{
			...
			category: "Data",
			options: ["Extend, Transform, Load", "Extract, Transform, Load", "Evaluate, Test, Launch", "Enable, Transfer, Link"],
	...
	"Cloud Computing": [
		...
		},
		{
			...
			category: "Cloud Computing",
			options: ["Amazon Web Services (AWS)", "Microsoft Azure", "Google Cloud Platform", "Adobe Cloud Systems"],
...
export const MOCK_INTRODUCTIONS: Record<string, string> = {
	"Cyber Security":
		"Welcome to the Cyber Security round! In today's digital world, protecting data and systems from threats is more critical than ever. Let's see how well you understand the principles of keeping information safe!",
	...
	"Cloud Computing":
		"Welcome to Cloud Computing! This technology has transformed how businesses deploy and scale their applications. Let's see what you know about services, deployment models, and cloud architecture!",
};
...
export const getMockIntroduction = (topic: string): string => {
	return (
		MOCK_INTRODUCTIONS[topic] || `Welcome to the ${topic} round! Let's test your knowledge and see how well you understand this exciting field!`
	);
};
