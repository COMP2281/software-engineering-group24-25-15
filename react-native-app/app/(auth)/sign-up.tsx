	...
	return (
	  <View className="flex-1">
		...
		<View className="absolute flex justify-center items-center w-full h-full">
		  ...
		  <TouchableOpacity
			className={`w-1/2 flex justify-center items-center bg-black-100 rounded-3xl py-3 mb-5 border-2 border-blue-100 ${loading ? "opacity-50" : ""}`}
			onPress={handleSignUp}
			disabled={loading}
		  >
			<Text className="text-grey-200 font-righteous uppercase">
